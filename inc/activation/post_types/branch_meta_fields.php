...
function add_branch_meta_boxes()
{
    ...
    add_meta_box(
        ...
        'branch_display_readonly_meta_fields', // Callback function
        $branch_post_type,                    // Post type - notice I changed this to 'product'
        'normal',
        'high'
    );
}

function branch_display_readonly_meta_fields($post)
{
